...
<body>
    ...
    <div class="container-fluid bg-dark mb-30">
        <div class="row px-xl-5 d-flex align-items-center">
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <div class="dropdown d-inline" style="margin-right: 90px">

                                <a class="btn btn-warning rounded dropdown-toggle" href="#" role="button"
                                ...
                                <ul class="dropdown-menu" style="margin-top: 11px">
                                    ...
                                    <li><a class="dropdown-item my-3" href="{{route('user#changePasswordPage')}}"><i class="fa-solid fa-arrow-right-arrow-left me-2"></i>Change Password</a></li>
                                    <li><a class="dropdown-item " href="#">
                                            <form action="{{ route('logout') }}" method="POST" class="d-inline">
                                                @csrf

                                                <button type="submit" class="" style="outline: none;border:none;background-color:transparent;margin:0;padding:0;">
