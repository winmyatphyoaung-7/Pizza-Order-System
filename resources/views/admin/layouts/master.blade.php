            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{route('admin#contactCreatePage')}}">
                                <i class="fa-solid fa-address-card"></i>User Contacts
                            </a>
                        </li>
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
                                                    <button class="" type="submit" style="width:100%;">

                                                        <a href="{{ route('admin#details') }}">
                                                            <i class="zmdi zmdi-account mr-3 "></i>Account
                                                        </a>
                                            ...
                                            <div class="account-dropdown__body" style="padding: 12px 0px;">
                                                <div class="account-dropdown__item">
                                                    <button class="" type="submit" style="width:100%;">
